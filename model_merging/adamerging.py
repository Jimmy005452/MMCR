...
from mmcr.adamerging import build_adamerging_loaders, build_adamerging_model, train_adamerging
...
def main():
    ...
    print(f"Saved AdaMerging encoder to {output_path}")
