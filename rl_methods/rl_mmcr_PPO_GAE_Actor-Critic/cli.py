...
def parse_args() -> argparse.Namespace:
    ...
    train.add_argument("--accuracy-imbalance-coef", type=float, default=0.25)
    train.add_argument("--retention-worst-coef", type=float, default=0.25)
    train.add_argument("--retention-drop-coef", type=float, default=0.5)
